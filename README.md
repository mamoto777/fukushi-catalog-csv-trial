...
**かんたん版(Excel・7項目・プルダウン選択、おすすめ)**

1. アプリのホーム画面で「自社データで試す」を選ぶ
2. 「かんたん版ひな形(Excel)をダウンロード」から `products-template-simple.xlsx` を取得する
3. Excelで開き、分類・困りごと・誰が使うをプルダウンから選んで記入する(形式変換不要、そのまま上書き保存)
4. 「記入したファイルを選ぶ(Excel / CSV)」から保存したファイルを読み込む

**フル版(CSV・15項目・手入力)**

1. 「自社データで試す」画面の「詳しく登録したい方(15項目CSV)」を開く
2. 「ひな形CSVをダウンロード」から `products-template.csv` を取得する
3. Excel等で商品データを記入する(15列。タグ類は決まった語彙のみ使用可。保存時は「CSV UTF-8」形式)
4. 「記入したファイルを選ぶ(Excel / CSV)」から保存したファイルを読み込む
